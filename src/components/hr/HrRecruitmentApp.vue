...
.nav-action {
  ...
  border: 1px dashed #cfd8e6; border-radius: 9px; margin-top: 6px; padding: 0 15px;
  background: #fff; color: #42506a; font: inherit; font-size: 15px; font-weight: 650;
  cursor: pointer; transition: border-color .18s, background .18s, color .18s;
}
.nav-action:hover { border-color: #1769ff; background: #f5f9ff; color: #1769ff; }
...
.account { gap: 10px; padding: 10px; text-align: left; }.account__copy { display: flex; min-width: 0; flex: 1; flex-direction: column; }.account__copy strong { overflow: hidden; font-size: 14px; text-overflow: ellipsis; white-space: nowrap; }.account__copy small { margin-top: 3px; color: #69758b; font-size: 12px; }
...
@media (max-width: 820px) {
  ...
  .brand { justify-content: center; padding: 0; }.brand > div,.main-nav a span,.nav-action span,.account__copy,.account > svg,.logout span { display: none; }
...
@media (max-width: 560px) {
  ...
  .brand { justify-content: flex-start; padding: 0 26px; }.brand > div,.main-nav a span,.nav-action span,.account__copy,.account > svg,.logout span { display: flex; }.main-nav a,.nav-action { justify-content: flex-start; padding: 0 15px; }.account { justify-content: flex-start; padding: 10px; }.logout { justify-content: flex-start; padding: 0 13px; }
