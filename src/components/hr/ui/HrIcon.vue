...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'chat'">
      <path d="M21 11.4a8.4 8.4 0 0 1-8.8 8.4 9.7 9.7 0 0 1-3.8-.8L3 20.5l1.5-4.3A8.4 8.4 0 1 1 21 11.4Z" />
    ...
    <template v-else-if="name === 'student'">
      <path d="m2 9 10-5 10 5-10 5Z" /><path d="M6 11.5V16c3 2.5 9 2.5 12 0v-4.5M22 9v6" />
    </template>
    ...
    <template v-else-if="name === 'key'">
      <circle cx="8" cy="15" r="4" /><path d="m11 12 9-9M18 5l2 2M15 8l2 2" />
    </template>
    ...
    <template v-else-if="name === 'phone'">
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.12 4.2 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.8a2 2 0 0 1-.45 2.11L8.1 9.9a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.84.57 2.8.7A2 2 0 0 1 22 16.92Z" />
    </template>
    ...
    <template v-else-if="name === 'paperclip'">
      <path d="m21.4 11.6-8.5 8.5a6 6 0 0 1-8.5-8.5l9.2-9.2a4 4 0 0 1 5.7 5.7l-9.2 9.2a2 2 0 0 1-2.9-2.8l8.5-8.5" />
    </template>
