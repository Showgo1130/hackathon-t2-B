...
.dialog__header { display: grid; grid-template-columns: 44px 1fr 38px; align-items: center; gap: 12px; padding: 20px 24px; border-bottom: 1px solid #e8edf4; }.dialog__title-icon { display: grid; width: 42px; height: 42px; place-items: center; border-radius: 11px; background: #edf3ff; color: #1769ff; }.dialog__header h2 { margin: 0; color: #172033; font-size: 17px; }.dialog__header p { margin: 4px 0 0; color: #78849a; font-size: 13px; }.dialog__header > button { display: grid; width: 36px; height: 36px; place-items: center; border: 0; border-radius: 9px; background: transparent; color: #47556d; cursor: pointer; }.dialog__header > button:hover { background: #f2f5f9; }
.dialog__body { overflow-y: auto; padding: 24px; }.dialog__body fieldset { margin: 0 0 22px; border: 0; padding: 0; }.dialog__body legend,.field > span { margin-bottom: 9px; color: #344054; font-size: 13px; font-style: normal; font-weight: 750; }.dialog__body legend span,.field > span i { color: #1769ff; font-size: 12px; font-style: normal; }
.role-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; }.role-grid label { position: relative; display: flex; min-width: 0; align-items: center; gap: 9px; border: 1px solid #dce3ed; border-radius: 10px; padding: 12px; cursor: pointer; transition: border .18s, background .18s; }.role-grid label:hover { border-color: #a8c2f5; }.role-grid label.selected { border-color: #1769ff; background: #f4f7ff; box-shadow: 0 0 0 2px rgb(23 105 255 / 7%); }.role-grid input { position: absolute; opacity: 0; }.role-icon { display: grid; flex: 0 0 auto; width: 34px; height: 34px; place-items: center; border-radius: 8px; background: #f0f3f8; color: #53617a; }.selected .role-icon { background: #e3edff; color: #1769ff; }.role-grid label > span:nth-child(3) { display: flex; min-width: 0; flex-direction: column; }.role-grid strong { color: #263247; font-size: 13px; }.role-grid small { overflow: hidden; margin-top: 3px; color: #7e899c; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }.role-grid i { display: none; width: 18px; height: 18px; margin-left: auto; place-items: center; border-radius: 50%; background: #1769ff; color: #fff; }.role-grid .selected i { display: grid; }
.form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; }.field { display: flex; flex-direction: column; margin-bottom: 18px; }.field input { width: 100%; min-width: 0; height: 43px; border: 1px solid #d6deea; border-radius: 8px; padding: 0 12px; outline: 0; color: #273348; font: inherit; font-size: 13px; }.field input:focus,.input-with-icon:focus-within,.password-input:focus-within { border-color: #1769ff; box-shadow: 0 0 0 3px rgb(23 105 255 / 9%); }.field > small { margin-top: 6px; color: #8791a3; font-size: 12px; }.field > small.error { color: #d04444; }
.input-with-icon,.password-input { display: flex; align-items: center; border: 1px solid #d6deea; border-radius: 8px; padding-left: 12px; color: #8994a7; }.input-with-icon input,.password-input input { border: 0; box-shadow: none; }.input-with-icon input:focus,.password-input input:focus { box-shadow: none; }.password-input > button { display: grid; height: 34px; place-items: center; border: 0; background: transparent; color: #6c788d; cursor: pointer; }.password-input .regenerate { display: flex; gap: 5px; margin-right: 5px; border-left: 1px solid #e0e5ed; padding: 0 8px; color: #1769ff; font-size: 12px; font-weight: 700; white-space: nowrap; }
.invite-option { display: flex; align-items: flex-start; gap: 9px; border: 1px solid #dce6f7; border-radius: 9px; padding: 13px; background: #f7faff; cursor: pointer; }.invite-option input { position: absolute; opacity: 0; }.checkbox { display: grid; width: 18px; height: 18px; flex: 0 0 auto; place-items: center; border: 1px solid #b8c5d9; border-radius: 5px; background: #fff; color: transparent; }.invite-option input:checked + .checkbox { border-color: #1769ff; background: #1769ff; color: #fff; }.invite-option > span:last-child { display: flex; flex-direction: column; }.invite-option strong { color: #30405a; font-size: 13px; }.invite-option small { margin-top: 3px; color: #7b879a; font-size: 12px; }
.server-error { margin: 12px 0 0; border: 1px solid #f1c9c9; border-radius: 8px; padding: 10px 12px; background: #fff5f5; color: #c43d3d; font-size: 12px; }
.dialog__footer { display: flex; justify-content: flex-end; gap: 10px; padding: 17px 24px; border-top: 1px solid #e8edf4; background: #fbfcfe; }.dialog__footer button { height: 42px; border-radius: 8px; padding: 0 19px; font-size: 13px; font-weight: 750; cursor: pointer; }.cancel-button { border: 1px solid #d6deea; background: #fff; color: #344054; }.create-button { display: flex; align-items: center; gap: 7px; border: 0; background: #1769ff; color: #fff; box-shadow: 0 6px 15px rgb(23 105 255 / 23%); }.create-button:disabled { background: #9ebdf8; cursor: not-allowed; box-shadow: none; }
