...
<template>
  <div class="chat-page">
    <header class="chat-header">
      ...
      <RouterLink v-if="role === 'student'" :to="{ name: 'hr-schedule-create', query: { students: route.params.id } }" class="schedule-link"><HrIcon name="calendar" :size="16" />日程調整を作成</RouterLink>
    </header>
...
<style scoped>
.chat-page,.chat-page *{box-sizing:border-box}.chat-page{display:grid;height:100%;grid-template-rows:77px minmax(0,1fr) 73px;background:#fff;color:#273348}.chat-header{display:flex;align-items:center;gap:11px;border-bottom:1px solid #e4e9f0;padding:0 22px}.chat-header>button{display:grid;width:34px;height:34px;place-items:center;border:0;border-radius:8px;background:transparent;color:#42506a;cursor:pointer}.chat-header>button:hover{background:#f1f4f8}.avatar{display:grid;width:39px;height:39px;place-items:center;border-radius:50%;font-size:14px;font-weight:800}.avatar--student{background:#dcf4e9;color:#157653}.avatar--interviewer{background:#ffead3;color:#a85c11}.chat-header>div{min-width:0}.chat-header h1{margin:0;font-size:15px}.chat-header h1 small{margin-left:3px;font-size:12px}.chat-header p{overflow:hidden;margin:4px 0 0;color:#768297;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.schedule-link{display:flex;height:36px;align-items:center;gap:7px;margin-left:auto;border-radius:8px;padding:0 12px;background:#1769ff;color:#fff;font-size:12px;font-weight:750;text-decoration:none}.chat-body{overflow-y:auto;padding:24px clamp(25px,7vw,90px);background:#fbfcfe}.empty{display:flex;height:100%;flex-direction:column;align-items:center;justify-content:center;color:#8994a6;font-size:12px}.empty>span{display:grid;width:48px;height:48px;place-items:center;border-radius:13px;background:#edf2f8}.empty strong{margin-top:10px;color:#536077}.empty p{margin:5px 0}.message-row{display:flex;align-items:flex-end;gap:8px;margin:0 0 17px}.message-row.mine{justify-content:flex-end}.message-avatar{display:grid;width:27px;height:27px;flex:0 0 auto;place-items:center;border-radius:50%;background:#e9eef5;color:#607087;font-size:12px;font-weight:800}.message-wrap{max-width:min(620px,75%)}.bubble{border:1px solid #e5e9ef;border-radius:5px 13px 13px 13px;padding:10px 13px;background:#fff;box-shadow:0 2px 8px rgb(35 49 75 / 3%)}.mine .bubble{border-color:#d6e3fb;border-radius:13px 5px 13px 13px;background:#edf3ff;color:#163f82}.system .bubble{background:#f7f9fc}.bubble>p{margin:0;white-space:pre-wrap;font-size:13px;line-height:1.75}.message-wrap time{display:block;margin-top:4px;color:#929bad;font-size:12px}.mine time{text-align:right}.schedule-summary{min-width:min(440px,60vw);margin-top:10px;border:1px solid #dce5f5;border-radius:10px;padding:11px;background:#fff;color:#273348}.schedule-summary header{display:flex;align-items:center;gap:6px;color:#1769ff}.schedule-summary header strong{font-size:13px}.schedule-summary dl{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin:10px 0}.schedule-summary dl div{border-radius:7px;padding:7px;background:#f7f9fc}.schedule-summary dt{color:#8994a6;font-size:12px}.schedule-summary dd{margin:3px 0 0;font-size:12px;font-weight:700}.schedule-summary>small{color:#758197;font-size:12px}.candidate-card{min-width:min(520px,66vw);margin-top:10px;border:1px solid #dce5f5;border-radius:10px;padding:12px;background:#fff;color:#273348}.candidate-card header{display:flex;align-items:center;gap:6px;color:#1769ff}.candidate-card header strong{font-size:13px}.candidate-count{margin-left:auto;border-radius:999px;padding:2px 9px;background:#edf3ff;color:#1c3a6e;font-size:13px;font-weight:750}.candidate-body{display:grid;grid-template-columns:300px minmax(0,1fr);gap:16px;margin-top:11px}.candidate-calendar{min-width:0}.candidate-list{display:flex;min-width:0;flex-direction:column;gap:6px;margin:0;padding:0;list-style:none}.candidate-list li{display:flex;align-items:baseline;gap:9px;border-radius:7px;padding:6px 8px;background:#f7f9fc}.candidate-date{flex:0 0 auto;color:#1a2235;font-size:13px;font-weight:750}.candidate-hours{display:flex;flex-wrap:wrap;gap:5px}.candidate-hours span{border:1px solid #dce5f5;border-radius:5px;padding:1px 6px;background:#fff;color:#42506a;font-size:13px;font-weight:650}.composer{display:flex;align-items:center;gap:9px;border-top:1px solid #e4e9f0;padding:0 clamp(22px,6vw,80px);background:#fff}.composer input{height:40px;min-width:0;flex:1;border:1px solid #dce3ed;border-radius:20px;padding:0 16px;outline:0;font:inherit;font-size:12px}.composer input:focus{border-color:#1769ff;box-shadow:0 0 0 3px rgb(23 105 255 / 7%)}.composer button{display:grid;width:40px;height:40px;place-items:center;border:0;border-radius:50%;background:#1769ff;color:#fff;cursor:pointer}.composer button:disabled{background:#c8d3e5;cursor:not-allowed}@media(max-width:600px){.chat-header{padding:0 12px 0 60px}.schedule-link{width:37px;padding:0;justify-content:center;font-size:0}.chat-body{padding:18px 12px}.message-wrap{max-width:88%}.schedule-summary{min-width:0}.schedule-summary dl{grid-template-columns:1fr}.candidate-card{min-width:0}.candidate-body{grid-template-columns:minmax(0,1fr)}.composer{padding:0 12px}}
</style>
